<nav class="flex flex-row justify-evenly w-full h-16px mt-6">
    ...
    <a href="#" class="{{request()->Routeis('contact') ? 'text-blue-500  w-1/5 h-1/2 my-auto font-semibold ':'text-white w-1/5 h-1/2 my-auto font-semibold  hover:text-blue-500 hover:border-b-red-500'}}"> Contact</a>
